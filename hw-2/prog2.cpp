...
int main() {
	...
	cout<<"Please choose data structure:" << endl<<"Press 1 for BST" <<endl << "Press 2 for AVL" << endl;
	int ds;
	cin >> ds;
if (ds == 1) {
...
"Press 5 to see the current height of the Tree" << endl;
		...
		cout << "Delete function not found in file" << endl;
               // cout << "Please enter a key to delete:" << endl;
               // int d;
               // cin >> d;
		//startTimer();
		...
		cout << "Replace function not found in file" << endl;
//                cout << "Please enter the new key:" << endl;
  //              int d;
    //            cin >> d;
      //          cout << "Please enter the old key to be replaced:" << endl;
